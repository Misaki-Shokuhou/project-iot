...
@section('title', 'Device | Smart')

@section('add-device')
  <a href="/add-device" class="btn btn-sm btn-outline-primary">Add Device</a>
@endsection
...
@section('content')
  <div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="col-xxl-12 mb-6 order-0">
      <div class="card">
      <div class="card">
        <h5 class="card-header">Your Device List</h5>
        ...
        <div class="dropdown">
          ...
          <a class="dropdown-item" href="{{ route('device.edit', $device->id_device) }}">
          <i class="icon-base bx bx-edit-alt me-1"></i> Edit
          </a>
          <form action="{{ route('device.destroy', $device->id_device) }}" method="POST"
          onsubmit="return confirm('Are you sure you want to delete this device?');">
          @csrf
          @method('POST') <!-- Karena di routes kamu delete itu pakai POST, bukan DELETE -->
      ...
      @empty
        ...
        No devices found. <a href="/add-device">Add Device</a>
        </td>
        </tr>
      @endforelse
          </tbody>
