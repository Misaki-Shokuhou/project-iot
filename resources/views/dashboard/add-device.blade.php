                                        ...
                                        <form action="{{ url('/add-device') }}" method="POST">
                                            ...
                                            <div class="row mb-6">
                                                <label class="col-sm-2 col-form-label"
                                                    for="basic-icon-default-fullname">Device Name</label>
                                                <div class="col-sm-10">
                                                    <div class="input-group input-group-merge">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            id="basic-icon-default-fullname" name="nama_device"
                                            ...
                                            <div class="row mb-6">
                                                <label class="col-sm-2 col-form-label"
                                                    for="basic-icon-default-company">UUID Device</label>
                                                <div class="col-sm-10">
                                                    <div class="input-group input-group-merge">
                                                        ...
                                                        <input type="text" id="basic-icon-default-company"
                                                            class="form-control" name="device_uid"
                                                            placeholder="SMRT-89527" required />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-6">
                                                <label class="col-sm-2 col-form-label"
                                                    for="basic-icon-default-tipe-device">Tipe Device</label>
                                                <div class="col-sm-10">
                                                    <div class="input-group input-group-merge">
                                                        <span class="input-group-text"><i
                                                                class="icon-base bx bx-category"></i></span>
                                                        <select id="basic-icon-default-tipe-device" class="form-control"
                                                            name="tipe_device" required>
                                                            <option value="" selected disabled>Pilih tipe device
                                                            </option>
                                                            <option value="Smart Home">Smart Home</option>
                                                            <option value="Smart Agriculture">Smart Agriculture</option>
