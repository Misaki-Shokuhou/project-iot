          ...
          <div class="card-body">
            ...
            <div class="app-brand justify-content-center">
              <a href="index.html" class="app-brand-link gap-2">
                ...
                <span class="app-brand-text demo text-heading fw-bold">Smart</span>
              </a>
            </div>
            <!-- /Logo -->
            <h4 class="mb-1">Welcome to Smart! </h4>
            ...
            <form id="formAuthentication" class="mb-6" action="{{ route('login.process') }}" method="POST">
              ...
              <div class="mb-6">
                ...
                <input type="text" class="form-control" id="email" name="email_username"
                  placeholder="Enter your email or username" autofocus value="{{ old('email_username') }}" />
              </div>
