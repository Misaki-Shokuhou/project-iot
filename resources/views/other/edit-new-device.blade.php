            ...
            <div class="row">
              ...
              <div class="col-xxl">
                <div class="card">
                  ...
                  <div class="card-body">
                    <form
                      action="{{ isset($device) ? route('admin.update', $device->id_unregistered) : route('admin.store') }}"
                      method="POST">
                      @csrf
                      @if (isset($device))
              @method('PUT')
                        ...
                        <div class="col-sm-10">
                          <div class="input-group input-group-merge">
                            ...
                            <input type="text" name="device_uid" class="form-control" id="basic-icon-default-fullname"
                              placeholder="SMRT-89527" aria-label="UUID Device"
                              aria-describedby="basic-icon-default-fullname2"
                              value="{{ old('device_uid', isset($device) ? $device->device_uid : '') }}" />
