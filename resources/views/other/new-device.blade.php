                                        ...
                                        <form action="{{ route('admin.store') }}" method="POST">
                                            ...
                                            <div class="row mb-6">
                                                <label class="col-sm-2 col-form-label"
                                                    for="basic-icon-default-fullname">UUID Device</label>
                                                <div class="col-sm-10">
                                                    <div class="input-group input-group-merge">
                                            ...
                                            <div class="row mb-6">
                                                ...
                                                <div class="col-sm-10">
                                                    <div class="input-group input-group-merge">
                                                        ...
                                                        <select name="tipe_device" id="basic-icon-default-tipe-device"
                                                            class="form-control" aria-label="Tipe Device"
                                                            aria-describedby="basic-icon-default-tipe-device2">
